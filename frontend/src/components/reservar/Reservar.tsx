...
// Mismos estilos que usa Facundo en ConsultarDisponibilidad, para mantener
...
const Reservar = () => {
  ...
  useEffect(() => {
    vehiculosApi
      ...
      .catch(() => setError("No se pudieron cargar los vehículos disponibles."));
  }, []);
  ...
  const handleReservar = async () => {
    ...
    if (!fechaInicio.isAfter(new Date())) {
    ...
    <section className="bg-gray-50/5 p-4 mx-10">
      ...
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center", pb: 3 }}>
          <Button variant="contained" onClick={handleReservar} disabled={loading}>
      ...
      {reservaCreada && (
        ...
        >
          ...
          <p>
            Vehículo: {reservaCreada.vehiculo.marca} {reservaCreada.vehiculo.modelo} (
            {reservaCreada.vehiculo.patente})
          </p>
